export default {
  ...
  report: {
    ...
    description:
      "Theo dõi các dòng công nợ từ vé đã xác nhận theo cùng dữ liệu với luồng nhập công nợ.",
  ...
  manualDebts: {
    ...
    filters: {
      ...
      to: "Đến",
      apply: "Áp dụng",
      barLabel: "Tìm kiếm và lọc bảng công nợ",
      searchLabel: "Tìm kiếm",
      searchPlaceholder:
        "Tìm khách hàng, hành khách, mã chỗ, số vé hoặc phương thức thanh toán",
      open: "Bộ lọc",
      dialogTitle: "Bộ lọc bảng công nợ",
      dialogDescription:
        "Kết hợp nhiều điều kiện. Dòng công nợ phải khớp tất cả điều kiện đã chọn.",
      column: "Cột",
      condition: "Điều kiện",
      addCondition: "Thêm điều kiện",
      removeCondition: "Xóa điều kiện",
      empty: "Chưa có điều kiện lọc.",
      reset: "Đặt lại",
      cancel: "Hủy",
    ...
    table: {
      ...
      actions: {
        ...
        saving: "Đang lưu...",
        invalidUpdate: "Vui lòng kiểm tra lại thông tin cần sửa.",
        updateSuccess: "Đã lưu thay đổi công nợ.",
        updateFailure: "Không thể cập nhật công nợ lúc này.",
        delete: "Xóa",
    ...
    validation: {
      ...
      customerIdInvalid: "Khách hàng không hợp lệ.",
      ticketIdInvalid: "Vé không hợp lệ.",
      bookedAtInvalid: "Ngày xuất vé không hợp lệ.",
      flightDateInvalid: "Ngày giờ bay không hợp lệ.",
      ticketNumberInvalid: "Số vé không hợp lệ.",
      airlineInvalid: "Hãng bay không hợp lệ.",
      itineraryInvalid: "Hành trình không hợp lệ.",
      paymentDateInvalid: "Ngày thanh toán không hợp lệ.",
      amountMin: "Số tiền không được nhỏ hơn 0.",
      paymentMethodInvalid: "Loại thanh toán không hợp lệ.",
      paymentNoteMax: "Ghi chú không được vượt quá 2000 ký tự.",
      paymentTransactionIdInvalid: "Thanh toán liên kết không hợp lệ.",
