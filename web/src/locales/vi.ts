export default {
  ...
  workbookEditor: {
    ...
    sheets: {
      ...
      ready: "Sẵn sàng",
      incomplete: "Thiếu cột",
      ambiguous: "Trùng cột",
      rowsColumns: "Dòng × cột",
      missing: "Thiếu",
      ambiguousFields: "Không xác định được",
      headerLabel: "Dòng tiêu đề",
      headerRow: "Dòng {row}",
      headerPreviewEmpty: "Không có nội dung chữ",
      mappingNote: "Ánh xạ trường nghiệp vụ chỉ là thông tin gợi ý và không chặn việc chỉnh sửa.",
      opening: "Đang mở...",
    ...
    errors: {
      ...
      mappingIncomplete: "Trang tính đang thiếu một số cột nghiệp vụ; bạn vẫn có thể mở và thêm cột sau.",
      mappingAmbiguous: "Trang tính có nhiều cột giá trùng tên.",
      network: "Không thể kết nối đến máy chủ. Vui lòng thử lại.",
    },
    editor: {
      loading: "Đang tải trình chỉnh sửa bảng tính...",
      columns: {
        add: "Thêm cột", addTitle: "Thêm cột mới", addDescription: "Cột do người dùng tạo có thể chỉnh sửa và xóa trong phiên làm việc này.",
        ...
        formulaDialogDescription: "Dựng biểu thức an toàn theo từng dòng bằng các lựa chọn hướng dẫn. Không chấp nhận công thức Excel nhập tự do.", simpleFormulaDescription: "Chọn hai cột có sẵn và phép tính. Bạn có thể tạo thêm nhiều cột công thức.",
        formulaNeedsColumns: "Cần ít nhất một cột số hoặc tiền tệ trước khi tạo công thức.", formulaBuilder: "Công thức", leftColumn: "Cột A", rightColumn: "Cột B", removeColumn: "Xóa cột", removeColumnConfirm: "Xóa cột {column}? Hành động này tạo một phiên bản mới.",
        ...
        examplesTitle: "Ví dụ được chấp nhận",
        examples: "Fare + 100000 · ROUND(Sale - Fare, 0) · MAX(Fare, Sale, 0) · SUM(Fare, Tax, Fee) · IF(Sale > Fare, Sale - Fare, 0)",
        builder: {
          nodeType: "Loại biểu thức", column: "Cột", constant: "Số", function: "Hàm",
          condition: "Điều kiện", whenTrue: "Khi đúng", whenFalse: "Khi sai", digits: "Số chữ số thập phân",
          addArgument: "Thêm giá trị", removeArgument: "Bỏ giá trị", parentheses: "Nhóm lồng nhau",
          rowLocalFunctions: "SUM, MIN và MAX chỉ kết hợp các ô được chọn trên cùng dòng hiện tại; không quét dòng khác hoặc vùng ô.",
          types: { column: "Cột", constant: "Số", binary: "Số học", comparison: "So sánh", if: "IF", round: "ROUND", function: "SUM / MIN / MAX" },
        },
        preview: {
