export default {
  ...
  workbookEditor: {
    ...
    errors: {
      uploadFailed: "Không thể tải bảng giá lên lúc này.",
    ...
    editor: {
      columns: {
        add: "Thêm cột", addTitle: "Thêm cột mới", addDescription: "Cột mới có thể chỉnh sửa và xóa trong phiên làm việc này.",
        label: "Tên cột", type: "Kiểu dữ liệu", manage: "Cột", manageTitle: "Quản lý cột",
        manageDescription: "Ẩn cột khi làm việc hoặc ghim các cột cần theo dõi. Cột từ tệp gốc không thể xóa.",
        visible: "Hiện", sticky: "Ghim", remove: "Xóa cột",
        formula: "Tính bằng công thức", formulaDescription: "Dùng hai cột số có sẵn trên cùng một dòng.",
        formulaNeedsColumns: "Cần ít nhất hai cột số hoặc tiền tệ trước khi tạo công thức.", formulaBuilder: "Công thức",
        leftColumn: "Cột thứ nhất", rightColumn: "Cột thứ hai", operator: "Phép tính", unnamed: "Cột không tên",
        formulaRowHint: "Mỗi dòng lấy giá trị từ các ô tương ứng.", percentHint: "Phần trăm tính cột thứ nhất × cột thứ hai ÷ 100.",
        distinctOperands: "Chọn hai cột khác nhau.",
        derived: "Công thức tự tính · chỉ đọc",
        types: { text: "Văn bản", number: "Số", date: "Ngày", currency: "Tiền tệ" },
      },
      unsavedCount: "{count} thay đổi chưa lưu",
      originalProtected: "Bản gốc được bảo vệ",
      version: "Phiên bản {version}",
      sheet: "Trang tính: {sheet}",
      searchPlaceholder: "Tìm hành khách, mã chỗ hoặc số vé",
      empty: "Không tìm thấy dòng dữ liệu phù hợp.",
      rowLabel: "dòng {row}",
      actions: {
