export default {
  ...
  workbookEditor: {
    ...
    start: {
      eyebrow: "Excel pricing workbook",
    ...
    errors: {
      uploadFailed: "Unable to upload the pricing workbook right now.",
    ...
    editor: {
      columns: {
        add: "Add column", addTitle: "Add a column", addDescription: "New columns can be edited and removed from this workbook session.",
        label: "Column name", type: "Data type", manage: "Columns", manageTitle: "Manage columns",
        manageDescription: "Hide columns while working or pin the columns you need to follow. Source columns cannot be removed.",
        visible: "Show", sticky: "Sticky", remove: "Remove column",
        formula: "Calculate with a formula", formulaDescription: "Use two existing numeric columns from the same row.",
        formulaNeedsColumns: "Add or import at least two number or currency columns first.", formulaBuilder: "Formula",
        leftColumn: "First column", rightColumn: "Second column", operator: "Operator", unnamed: "Unnamed column",
        formulaRowHint: "Each row uses the values from its matching cells.", percentHint: "Percent calculates first column × second column ÷ 100.",
        distinctOperands: "Choose two different columns.",
        derived: "Calculated formula · read-only",
        types: { text: "Text", number: "Number", date: "Date", currency: "Currency" },
      },
      unsavedCount: "{count} unsaved changes",
      originalProtected: "Original protected",
      version: "Version {version}",
      sheet: "Worksheet: {sheet}",
      searchPlaceholder: "Search passenger, booking code, or ticket number",
      empty: "No matching business rows were found.",
      rowLabel: "row {row}",
      actions: {
