export default {
  ...
  manualDebts: {
    ...
    filters: {
      ...
      to: "To",
      apply: "Apply",
      barLabel: "Search and filter the debt table",
      searchLabel: "Search",
      searchPlaceholder:
        "Search customers, passengers, PNRs, ticket numbers, or payment methods",
      open: "Filters",
      dialogTitle: "Debt table filters",
      dialogDescription:
        "Combine conditions. A debt row must match every selected condition.",
      column: "Column",
      condition: "Condition",
      addCondition: "Add condition",
      removeCondition: "Remove condition",
      empty: "No filter conditions yet.",
      reset: "Reset",
      cancel: "Cancel",
