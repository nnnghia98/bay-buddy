export default {
  ...
  workbookEditor: {
    ...
    sheets: {
      ...
      missing: "Missing",
      ambiguousFields: "Could not identify",
      headerLabel: "Header row",
      headerRow: "Row {row}",
      headerPreviewEmpty: "No text values",
      mappingNote: "Business-field mapping is optional metadata and does not block editing.",
      opening: "Opening...",
    ...
    errors: {
      ...
      mappingIncomplete: "The sheet is missing some business columns; you can still open it and add them later.",
      mappingAmbiguous: "The sheet contains duplicate price-column names.",
      network: "The server could not be reached. Try again.",
    },
    editor: {
      loading: "Loading workbook editor...",
      columns: {
        add: "Add column", addTitle: "Add a column", addDescription: "New user columns can be edited and removed from this workbook session.",
        ...
        formulaDialogDescription: "Build a safe row-local expression with guided controls. Raw Excel formulas are not accepted.", simpleFormulaDescription: "Choose two existing columns and one operation. You can create more formula columns when needed.",
        formulaNeedsColumns: "Add or import at least one number or currency column first.", formulaBuilder: "Formula", leftColumn: "Column A", rightColumn: "Column B", removeColumn: "Delete column", removeColumnConfirm: "Delete {column}? This creates a new workbook version.",
        ...
        examplesTitle: "Accepted examples",
        examples: "Fare + 100000 · ROUND(Sale - Fare, 0) · MAX(Fare, Sale, 0) · SUM(Fare, Tax, Fee) · IF(Sale > Fare, Sale - Fare, 0)",
        builder: {
          nodeType: "Expression type", column: "Column", constant: "Number", function: "Function",
          condition: "Condition", whenTrue: "When true", whenFalse: "When false", digits: "Decimal digits",
          addArgument: "Add value", removeArgument: "Remove value", parentheses: "Nested group",
          rowLocalFunctions: "SUM, MIN, and MAX combine only the selected cells from the current row. They do not scan other rows or ranges.",
          types: { column: "Column", constant: "Number", binary: "Arithmetic", comparison: "Comparison", if: "IF", round: "ROUND", function: "SUM / MIN / MAX" },
        },
        preview: {
